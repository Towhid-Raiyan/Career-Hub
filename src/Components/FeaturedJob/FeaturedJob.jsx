...
const FeaturedJob = ({ job }) => {
    ...
    return (
        <div className=" p-2 sm:p-6 border-solid border-2 static mx-3">
            ...
            <Link to={`../job/${job_id}`}> <button className="btn-primary mt-10  px-4 py-2 rounded-lg text-white"> View Details</button></Link>
